...
@Bot.on_message(
    ...
    & filters.user(ADMINS)
    & ~filters.command(
        ["start", "users", "broadcast", "ping", "uptime", "batch", "link", "sange", "admin", "tentang", "donasi", "perintah"]
    )
)
...
async def niw_post(client: Client, message: Message):
...
async def neew_post(client: Client, message: Message):
...
async def neuw_post(client: Client, message: Message):
